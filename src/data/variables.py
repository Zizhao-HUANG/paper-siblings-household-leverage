...
DEBT_HOUSE_BANK: List[VarSpec] = [
    VarSpec(f"c2064_{i}", f"c2064it_{i}") for i in range(1, 7)
]
DEBT_HOUSE_OTHER: List[VarSpec] = [
    VarSpec(f"c3002a_{i}", f"c3002ait_{i}") for i in range(1, 7)
]
...
ASSET_HOUSE: List[VarSpec] = [
    VarSpec(f"c2016_{i}", f"c2016it_{i}") for i in range(1, 7)
]
...
ASSET_BOND: List[VarSpec] = [
    VarSpec(f"d4103_{i}", f"d4103it_{i}") for i in range(1, 6)
]
